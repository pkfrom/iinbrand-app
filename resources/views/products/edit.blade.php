        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('products.update', $product->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('company_id')) has-error @endif">
                    ...
                    <input type="text" id="company_id-field" name="company_id" class="form-control" value="{{ $product->company_id }}"/>
                    ...
                    <textarea class="form-control" id="detail-field" rows="3" name="detail">{{ $product->detail }}</textarea>
                    ...
                    <input type="text" id="activate-field" name="activate" class="form-control" value="{{ $product->activate }}"/>
                    ...
                    <input type="text" id="picture-field" name="picture" class="form-control" value="{{ $product->picture }}"/>
